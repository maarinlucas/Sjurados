                        ...
                        <View style={stylesModalAjuda.modalBackground}>
                            <View style={stylesModalAjuda.modalContainer}>
                                <ScrollView>
                                    ...
                                    <Text style={stylesModalAjuda.item}>3. Trocadilho</Text>
                                    <Text style={stylesModalAjuda.item}>4. Anadiplose</Text>
                                    <Text style={stylesModalAjuda.item}>5. Multissilábicas Um Dois</Text>
                                    <Text style={stylesModalAjuda.item}>6. Esdrúxulas</Text>
                                    <Text style={stylesModalAjuda.item}>7. Univocalismo</Text>
                                    <Text style={stylesModalAjuda.item}>8. Derivação</Text>
                                    <Text style={stylesModalAjuda.item}>9. Antanáclase</Text>
                                    <Text style={stylesModalAjuda.item}>10. Retruécano</Text>
                                    <Text style={stylesModalAjuda.item}>11. Anáfora</Text>
                                    <Text style={stylesModalAjuda.item}>12. Antítese</Text>
                                    <Text style={stylesModalAjuda.item}>13. Comparação</Text>
                                    <Text style={stylesModalAjuda.item}>14. Hipérbole</Text>
                                    <Text style={stylesModalAjuda.item}>15. Anfibologia</Text>
                                    <Text style={stylesModalAjuda.item}>16. Metáfora</Text>
                                    <Text style={stylesModalAjuda.item}>17. Esquemas</Text>
                                    <Text style={stylesModalAjuda.item}>18. Rimas perfeitas (coerência com fatality)</Text>
                                    <Text style={stylesModalAjuda.item}>19. Métricas</Text>
